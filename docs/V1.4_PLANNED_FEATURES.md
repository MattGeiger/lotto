...
### Phase 1: Theme Architecture + Hi-viz Foundation

- Add contrast mode infrastructure and persistence.
- Implement menu changes + icon labels.
- Introduce high-contrast tokens and scope classes.
- Validate all pages in light/dark/system/hi-viz combinations.
