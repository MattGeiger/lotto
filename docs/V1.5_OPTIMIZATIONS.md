...
**Status:** Phases 1, 2, 3, 4a, key Phase 4/6 items, feature-flagged optimistic action UX, and draw-path pending/render isolation are implemented. Remaining work reprioritized below.  
**Target branch:** `main`  
...
8. Load `/display` with large ticket grid and compare first meaningful paint before/after animation caps.
9. Validate no regression in Issue 14 and Issue 15 behavior in `docs/ISSUES.md`.
