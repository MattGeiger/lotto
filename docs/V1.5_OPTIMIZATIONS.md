...
**Status:** Phases 1, 2, 3, 4a, key Phase 4/6 items, feature-flagged optimistic action UX, draw-path pending/render isolation, and history-cost controls are implemented. Remaining work reprioritized below.  
**Target branch:** `main`  
...
9. Load `/display` with large ticket grid and compare first meaningful paint before/after animation caps.
10. Validate no regression in Issue 14 and Issue 15 behavior in `docs/ISSUES.md`.
...
- `npm test`:
  - 383 assertions passed across 41 test files.
