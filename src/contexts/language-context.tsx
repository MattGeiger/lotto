...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    brickMayhemInstructionPaddle: "USE THE PADDLE TO MOVE",
    brickMayhemInstructionStrike: "STRIKE BRICKS WITH THE BALL",
    brickMayhemInstructionDrop: "DON'T DROP THE BALL!",
    brickMayhemInstructionClear: "CLEAR BRICKS TO MAKE A PATH",
  ...
  zh: {
    ...
    brickMayhemInstructionPaddle: "用挡板移动",
    brickMayhemInstructionStrike: "用球击碎砖块",
    brickMayhemInstructionDrop: "不要让球掉落！",
    brickMayhemInstructionClear: "清除砖块开辟道路",
  ...
  es: {
    ...
    // Brick Mayhem
    brickMayhemTitle: "Brick Mayhem",
    brickMayhemInstructionPaddle: "USA LA PALETA PARA MOVERTE",
    brickMayhemInstructionStrike: "GOLPEA LADRILLOS CON LA BOLA",
    brickMayhemInstructionDrop: "NO DEJES CAER LA BOLA!",
    brickMayhemInstructionClear: "ROMPE LADRILLOS PARA ABRIR CAMINO",
  ...
  ru: {
    ...
    // Brick Mayhem
    brickMayhemTitle: "Brick Mayhem",
    brickMayhemInstructionPaddle: "ДВИГАЙТЕ РАКЕТКУ",
    brickMayhemInstructionStrike: "РАЗБИВАЙТЕ КИРПИЧИ МЯЧОМ",
    brickMayhemInstructionDrop: "НЕ УРОНИТЕ МЯЧ!",
    brickMayhemInstructionClear: "РАСЧИСТИТЕ ПУТЬ",
  ...
  uk: {
    ...
    // Brick Mayhem
    brickMayhemTitle: "Brick Mayhem",
    brickMayhemInstructionPaddle: "РУХАЙТЕ РАКЕТКУ",
    brickMayhemInstructionStrike: "РОЗБИВАЙТЕ ЦЕГЛИНИ М'ЯЧЕМ",
    brickMayhemInstructionDrop: "НЕ ВПУСТІТЬ М'ЯЧ!",
    brickMayhemInstructionClear: "РОЗЧИСТІТЬ ШЛЯХ",
  ...
  vi: {
    ...
    // Brick Mayhem
    brickMayhemTitle: "Brick Mayhem",
    brickMayhemInstructionPaddle: "DÙNG THANH ĐỠ ĐỂ DI CHUYỂN",
    brickMayhemInstructionStrike: "ĐÁNH BÓNG VÀO GẠCH",
    brickMayhemInstructionDrop: "ĐỪNG ĐỂ BÓNG RƠI!",
    brickMayhemInstructionClear: "PHÁ GẠCH ĐỂ MỞ ĐƯỜNG",
  ...
  fa: {
    ...
    // Brick Mayhem
    brickMayhemTitle: "Brick Mayhem",
    brickMayhemInstructionPaddle: "از راکت برای حرکت استفاده کنید",
    brickMayhemInstructionStrike: "آجرها را با توپ بزنید",
    brickMayhemInstructionDrop: "توپ را نیندازید!",
    brickMayhemInstructionClear: "آجرها را بشکنید تا راه باز شود",
  ...
  ar: {
    ...
    // Brick Mayhem
    brickMayhemTitle: "Brick Mayhem",
    brickMayhemInstructionPaddle: "استخدم المضرب للتحرك",
    brickMayhemInstructionStrike: "اضرب الطوب بالكرة",
    brickMayhemInstructionDrop: "لا تسقط الكرة!",
    brickMayhemInstructionClear: "حطم الطوب لفتح الطريق",
